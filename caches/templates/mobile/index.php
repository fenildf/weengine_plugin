...
<a class="diy-control-item" href="{php echo $this->createMobileurl('list', array('id'=>$item['tid']))}"><?php  echo $item['title'];?></a>
<?php  } } ?>
...
<ul class="mui-table-view mui-grid-view mui-grid-9 main-content" >
		...
		<h5 class="mui-content-padded"><span class="content-nav-tip tiny-game-tip">精</span> <span class="content-title"><?php  echo $row['title'];?></span> <a class="diy-more" href="{php echo $this->createMobileurl('list', array('id'=>$row['tid']))}"> 更多<i class="iconfont icon-right"></i></a> </h5>
...
<script type="text/javascript">
	var swiper = new Swiper('#banner-slider', {
		...
		$('#search-btn').click(function(){
			...
			window.location.href="{php echo $this->createMobileurl('search')}&p="+encodeURIComponent($search.val());
